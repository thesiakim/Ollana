...
Widget build(BuildContext context) {
  ...
  return Scaffold(
    ...
    appBar: AppBar(
      ...
      // 산 정보 카드를 AppBar bottom에서 body로 이동
      bottom: PreferredSize(
        preferredSize: Size.fromHeight(70), // 70으로 변경
        child: Padding(
                            ...
                            return Container(
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                    color: isSelected 
                                        ? Color(0xFFEAF6F0) // 선택된 카드는 밝은 민트색
                                        : Colors.white,
                                    borderRadius: BorderRadius.circular(16),
                                    boxShadow: [
                                      BoxShadow(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    elevation: 0, // 엘리베이션 제거
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(14), // 14로 변경
                    ),
                  ),
                  child: Text( // Row 대신 그냥 Text만 사용
                    '선택 완료',
                    style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 15, // 15로 변경
                            ...
                            ElevatedButton(
                              onPressed: _selectedRecordId != null
                                  ? () {
                                      ...
                                      final timeInSeconds =
                                          ((selectedRecord['time'] as num) * 60).toInt();
